...
class OntologyManager:
    ...
    def get_schema(self, name: str, version: Optional[str] = None) -> Optional[OntologySchema]:
        """
        ...
        versions = sorted(self.schemas[name].keys(), key=lambda v: OntologyVersion.from_string(v))
        if not versions:
            return None
    ...
    def create_new_version(self, name: str, increment: str = "patch") -> Optional[OntologySchema]:
        """
