...
class IngestionRequest(BaseModel):
    ...
    is_structured_pdf: bool = Field(False, description="Whether PDF has structured data")
...
class RetrievalRequest(BaseModel):
    ...
    enable_references_citations: bool = Field(True, description="Whether to include citations")
    deep_research: bool = Field(False, description="Whether to use advanced retrieval techniques")
    auto_chunk_sizing: bool = Field(True, description="Whether to auto-determine chunk count")
    model: Optional[str] = Field(None, description="LLM model to use")
    max_tokens: Optional[int] = Field(None, description="Maximum tokens for LLM")
