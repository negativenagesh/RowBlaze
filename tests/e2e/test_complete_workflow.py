                ...
                try:
                    ...
                    with open(tmp_file_path, "rb") as file:
                        ...
                        if upload_response.status_code not in [200, 400, 422]:
                            pytest.skip(
                                f"Upload endpoint not working properly: {upload_response.status_code}"
                            )
                    ...
                    if upload_response.status_code == 200:
                        ...
                        query_response = await client.post(
                            f"{api_base_url}/query", json=query_payload
                        )
                        ...
                        if query_response.status_code == 200:
                            ...
                            pytest.skip(
                                f"Query endpoint not working: {query_response.status_code}"
                            )
